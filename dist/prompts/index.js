...
exports.auditWiseComparisonPrompt = exports.sbuWiseComparisonPrompt = exports.supervisorSummaryAgentPrompt = exports.chartPrompt = void 0;
exports.chartPrompt = `
...
`;
const supervisorSummaryAgentPrompt = (reportToSummarize, userRequest, currentDate) => {
    return `
...
exports.supervisorSummaryAgentPrompt = supervisorSummaryAgentPrompt;
const sbuWiseComparisonPrompt = (jsonData) => `
...
`;
exports.sbuWiseComparisonPrompt = sbuWiseComparisonPrompt;
const auditWiseComparisonPrompt = (jsonData) => `
...
GIVE THE OUTPUT IN MARKDOWN FORMAT. without any other text and fabrication.
`;
exports.auditWiseComparisonPrompt = auditWiseComparisonPrompt;
